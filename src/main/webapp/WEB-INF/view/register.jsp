        ...
        <div class="layui-form login-form">
            <form class="layui-form" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <input type="text" name="email" id="email"  placeholder="邮箱" autocomplete="off" class="layui-input" value="">
                </div>
                <div class="layui-form-item">

                    <input type="text" name="number" id="number"  placeholder="学号/工号" autocomplete="off" class="layui-input" value="">
                </div>
                <div class="layui-form-item">

                    <input type="text" name="username" id="username"  placeholder="姓名" autocomplete="off" class="layui-input" value="">
                </div>
                <div class="layui-form-item">

                    <input type="password" name="password" id="password" placeholder="密码" autocomplete="off" class="layui-input" value="">
                </div>
