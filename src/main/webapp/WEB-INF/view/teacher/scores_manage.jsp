    ...
    <table id="table_233">
        ...
        <tr>
            <td colspan="6" style="text-align: left;padding: 8px;font-size: 12px;">
                注：备注一栏是自动生成的，用于查看学生是否已考。如果学生没有交卷，那么该学生的成绩这一栏为空
                <ol style="margin: 10px 0 0 25px;">
                    <li style="list-style: initial;">考试中 -- 该学生已答题，但未交卷。</li>
                    <li style="list-style: initial;">已交卷 -- 该学生已交卷，当前学生的考试已结束。</li>
                    <li style="list-style: initial;">未考 -- 该学生还没进入本次考试，但考试时间未到，本次考试未考</li>
                    <li style="list-style: initial;">缺考 -- 该学生还没进入本次考试，但考试时间已到；或者该学生忘记在规定的时间内点击交卷。本次考试缺考</li>
                </ol>
            </td>
        </tr>
        </tbody>
